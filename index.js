...
process.stdin.on('data', function (chunk) {
  ...
  if (chunk[0] === 'not') {
    ...
    g.edges = g.edges.filter(function (edge) { return edge.weight !== index })
    console.log(index)
    people = people.filter(function (person) { return person !== chunk[1] })
    places = places.filter(function (place) { return place !== chunk[3] })
  }
