/**
 * lib/strategies/find-a-card-non-strict.js - Detective
 * license GPLv2.
...
module.exports = function () {
    ...
    var clone = Guess[best.type === 'place' ? 'room' : best.type].filter(function (card) {
        return card.itm !== best.itm;
    });

    // calculate new master probability
    console.log(clone)
    var masterprob = clone.length > 0 ? clone.first().prob : 1;
    for (var stack in Guess) {
