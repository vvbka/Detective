...
module.exports = function (room) {
  ...
  var $global = this.$global, tops = [$global.master.Guess.person.first(), $global.master.Guess.room.first(), $global.master.Guess.weapon.first()], target, initProb=0, startI;
 ...
 */ 
  ...
  //console.log(NCARR1)
  var NC1 = NCARR1[ Math.floor(Math.random()*NCARR1.length)] //pick a random card from that set
  //console.log('NC1'+NC1)
  ...
  var NC2 = NCARR2[ Math.floor(Math.random()*NCARR2.length)] //pick a random card from that set
  //console.log('NC2'+NC2)
